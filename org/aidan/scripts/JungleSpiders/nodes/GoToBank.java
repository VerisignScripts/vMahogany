...
public class GoToBank extends Node {
    ...
    public boolean activate() {
        return !Inventory.contains(Vars.FOOD_IDS) && Calculations.distanceTo(Vars.BANK_TILE) > 8;
    }

    @Override
    public void execute() {
        JSKR.s = "Executing Walk-To-Bank";
        if (Vars.BANK_TILE.isOnMap()) {
            if  (Vars.BANK_TILE.clickOnMap()) {
