...
public class Vars {
    ...
    public static final Tile spiderTile =  new Tile(2671, 3086, 0);
    public static final Tile bankTile =  new Tile(2613, 3092, 0);
    public static final int lobster = 379;
    public static int shieldId = 1201;
    public static final int[] FOOD_IDS = {379,333, 351, 329,
            361, 365,
            373, 7946, 385, 697, 391, 15266, 15272};
    public static final int carcass = 6291;
    public static final Area combatArea = new Area(new Tile[] { new Tile(2673, 3091, 0), new Tile(2669, 3091, 0), new Tile(2667, 3089, 0),
            new Tile(2667, 3087, 0), new Tile(2667, 3086, 0), new Tile(2669, 3086, 0),
            new Tile(2672, 3083, 0), new Tile(2673, 3086, 0) });;
}
